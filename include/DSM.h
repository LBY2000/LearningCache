...
public:
  ...
  void read_batch(RdmaOpRegion *rs,int k,bool signal=false);
...
//                         CoroContext *ctx = nullptr);
  ...
  void write_dm(const char *buffer, GlobalAddress gaddr, size_t size,
                bool signal = true, CoroContext *ctx = nullptr);
  void LI_write_dm(const char *buffer, GlobalAddress gaddr, size_t size,
                bool signal = false, CoroContext *ctx = nullptr);
  ...
  void cas_dm(GlobalAddress gaddr, uint64_t equal, uint64_t val,
              uint64_t *rdma_buffer, bool signal = true,
              CoroContext *ctx = nullptr);
    void LI_cas_dm(GlobalAddress gaddr, uint64_t equal, uint64_t val,
              uint64_t *rdma_buffer, bool signal = false,
              CoroContext *ctx = nullptr);
  bool cas_dm_sync(GlobalAddress gaddr, uint64_t equal, uint64_t val,
                   uint64_t *rdma_buffer, CoroContext *ctx = nullptr);
    bool LI_cas_dm_sync(GlobalAddress gaddr, uint64_t equal, uint64_t val,
                   uint64_t *rdma_buffer, CoroContext *ctx = nullptr);
